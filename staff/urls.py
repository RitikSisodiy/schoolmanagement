...
urlpatterns= [
    ...
    path('delete/student/<slug:username>',views.delstudent,name='deletestudent'),
    ...
    path('gallery/<int:id>/<slug:opration>',views.editgallery,name='editgallery'),
    path('gallery/delete/<int:id>',views.deleteimage,name='deleteimage'),
